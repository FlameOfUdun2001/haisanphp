    ...
    <div class="container_12">
                ...
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            <li>Chào mừng <?php echo Session::get('adminName') ?></li>
        ...
        <div class="grid_12">
            <ul class="nav main">
                ...
                <li class="ic-form-style"><a href=""><span>Thông tin NV</span></a></li>
                ...
                <li class="ic-charts"><a href=""><span>Tới Website</span></a></li>
            </ul>
        </div>
        <div class="clear">
        </div>
