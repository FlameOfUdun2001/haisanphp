	...
	class product
	{
		...
		public function insertCompare($productid, $customer_id){
			...
			if($result_check_compare){
				$msg = "<span class='error'>Sản phẩm đã được đưa vào phần so sánh</span>";
				return $msg;
			}else{
		...
		public function insertWishlist($productid, $customer_id){
			...
			if($result_check_wlist){
				$msg = "<span class='error'>Sản phẩm đã được đưa vào mục yêu thích</span>";
				return $msg;
			}else{
			...
			if($insert_wlist){
						...
						$alert = "<span class='error'>Thêm vào mục so sánh thành công</span>";
						return $alert;
					}
			}
		}
