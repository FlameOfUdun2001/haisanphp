...
<?php
	...
	class brand
	{
		...
		public function insert_brand($brandName){
			...
			if(empty($brandName)){
				$alert = "<span class='error'>Xuất sứ không được trống</span>";
				return $alert;
			}else{
				$query = "INSERT INTO tbl_brand(brandName) VALUES('$brandName')";
				$result = $this->db->insert($query);
				if($result){
					$alert = "<span class='success'>Thêm xuất sứ thành công</span>";
					return $alert;
				}else{
					$alert = "<span class='error'>Thêm xuất sứ không thành công</span>";
					return $alert;
				}
			}
		}
		...
		public function update_brand($brandName,$id){
			...
			if(empty($brandName)){
				...
				if($result){
					$alert = "<span class='success'>Sửa xuất sứ thành công</span>";
					return $alert;
				}else{
					$alert = "<span class='error'>Xuất sứ chưa được sửa</span>";
					return $alert;
				}
			}
